...
export type WaypointType = 'mirador' | 'puente' | 'fuente' | 'enlace' | 'iglesia' | 'hermita' | 'arbol' | 'laguna' | 'lago' | 'refugio' | 'albergue' | 'casa' | 'pico' | 'montaña' | 'collado' | 'cascada' | 'unknown'
...
export type { BlogStatus, BlogPost } from './blog'
